 ...
 *
 * A raw constraint error on screen — 'insert or update on table "x" violates
 * foreign key constraint "x_user_id_fkey"' — tells the user nothing about what
 * to do, and leaks the schema while it is at it.
 *
...
export function humanizeDbError(
  ...
  switch (error?.code) {
    case '23503': // foreign_key_violation
      return 'We could not finish setting up your InterviewForge account. Please try again — if it keeps happening, sign out and back in.'
    case '23505': // unique_violation
      return 'That already exists.'
    case '23514': // check_violation
      return "Some of that doesn't look right — check the values and try again."
